...
st.write("""
# AWS Prediction App
### Created By : [Tevin Dean Ramadhan](https://deantevin.github.io/)
Data obtained from the [palmerpenguins library](https://github.com/anggitapmj/bebas/main/) in R by Allison Horst.
""")

st.sidebar.header('User Input Features')
st.sidebar.markdown("""
[Example CSV input file](https://raw.githubusercontent.com/DeanTevin/Machinelearning/master/dataaing/citeko-2018-2020.csv)
""")
...
if uploaded_file is not None:
   ...
   urlData = 'https://raw.githubusercontent.com/DeanTevin/Machinelearning/master/dataaing/citeko-2018-2020.csv'
...
with st.expander("Temperature Anomalies"):
...
with st.expander("Pressure Anomalies"):
  train_size = int(len(df_Data) * .80)
  test_size = len(df_Data) - train_size
...
with st.expander("Solrad Anomalies"):
  train_size = int(len(df_Data) * .80)
  test_size = len(df_Data) - train_size
